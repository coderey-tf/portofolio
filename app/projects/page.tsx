  ...
  return (
    <div className="divide-y divide-gray-500 dark:divide-gray-700">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-8 pt-8 space-y-8">
          {data.map((project) => {
            return (
              <article
                key={project._id}
                className=" dark:border-zinc-600 rounded-lg border border-gray-400 bg-white shadow-lg dark:bg-black  shadow-gray-500 hover:scale-105 transition-all duration-300"
              >
